...
const SideNav = () => {
  ...
  <div className='hidden md:block'>
    <div className='flex items-center mb-4 p-5 rounded bg-zinc-800 hover:bg-zinc-800'>
    ...
    <button className='font-bold py-2 px-4 rounded  items-center' onClick={() => setIsOpen(!isOpen)}>
